...
const SAYINGS = [
  "I'm going to the docker later and order some French fries.",
  "树在。山在。大地在。岁月在。我在。",
  "我们周围并非没有光亮，只是太耀眼将我们灼伤。",
  "越是贪图完满，越是搜不干净。",
  "不诱于誉，不恐于诽，率道而行，端然正己。",
  "人生若只如初见。",
  "当你拥有强烈执行力的时候，你的未来就靠想象力了。",
  "那些听不见音乐的人，以为跳舞的人疯了。",
  "如果你无意间装饰了明月的窗子，那我来装饰你的梦。",
  "我见青山多妩媚，料青山见我应如是。",
  "人啊，就是这样。花大把时间迷茫，在几个瞬间成长。",
  "如果生活把你的门关上了，那你就再打开，门就是这样用的。",
];

const initOneSentence = () => {
  saying.value = [SAYINGS[Math.floor(Math.random() * SAYINGS.length)]];
};
...
const getBgCover = computed(() => {
  ...
  // 做一个根据路由来判断判断页面背景图片
  let url;
  let myUrl = "/wallpapers/68686407_p0.jpg";
...
<template>
  <div id="home">
    ...
    <div class="font">Wintel.&#39;s Blog</div>
