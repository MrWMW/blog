    ...
    <el-card class="!m-[3px] !p-[10px]">
      <el-descriptions :column="1">
        ...
        <el-descriptions-item label="博客链接"
          ><span v-copy="'https://yourdomain.com/'" class="!cursor-pointer">https://yourdomain.com/</span>
        </el-descriptions-item>
        <el-descriptions-item label="QQ">
          <span v-copy="'your-qq-number'" class="!cursor-pointer">your-qq-number</span>
        </el-descriptions-item>
        <el-descriptions-item>
          ...
          <el-card class="card-hover animate__animated animate__fadeIn">
            <div
              ...
              :style="{
                zIndex: 1,
                backgroundImage: `url(${
                  item.site_avatar || 'https://your-cdn.example.com/FgTOrGUz5WJwswSLhPsiGL4DOXe3'
                })`,
              }"
